...
export async function initializeDb() {
    ...
    try {
        await db.exec(`
            ...
            CREATE TABLE IF NOT EXISTS chat_messages ( id INTEGER PRIMARY KEY AUTOINCREMENT, sender_id INTEGER NOT NULL, receiver_id INTEGER, message TEXT NOT NULL, message_type TEXT DEFAULT 'text', sent_at DATETIME DEFAULT CURRENT_TIMESTAMP, read_at DATETIME, FOREIGN KEY (sender_id) REFERENCES users(id) ON DELETE CASCADE, FOREIGN KEY (receiver_id) REFERENCES users(id) ON DELETE CASCADE);
            CREATE TABLE IF NOT EXISTS blocked_users ( id INTEGER PRIMARY KEY AUTOINCREMENT, blocker_id INTEGER NOT NULL, blocked_id INTEGER NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (blocker_id) REFERENCES users(id) ON DELETE CASCADE, FOREIGN KEY (blocked_id) REFERENCES users(id) ON DELETE CASCADE, UNIQUE(blocker_id, blocked_id));
            CREATE TABLE IF NOT EXISTS game_invitations ( id INTEGER PRIMARY KEY AUTOINCREMENT, inviter_id INTEGER NOT NULL, invitee_id INTEGER NOT NULL, status TEXT DEFAULT 'pending', game_id TEXT, created_at DATETIME DEFAULT CURRENT_TIMESTAMP, responded_at DATETIME, FOREIGN KEY (inviter_id) REFERENCES users(id) ON DELETE CASCADE, FOREIGN KEY (invitee_id) REFERENCES users(id) ON DELETE CASCADE);
            CREATE TABLE IF NOT EXISTS tournaments ( id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL, created_by INTEGER, status TEXT DEFAULT 'pending', players INTEGER DEFAULT 8, bots BOOLEAN DEFAULT 0, bots_difficulty TEXT DEFAULT "-", created_at DATETIME DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (created_by) REFERENCES users(id) ON DELETE SET NULL);
            CREATE TABLE IF NOT EXISTS tournament_participants ( id INTEGER PRIMARY KEY AUTOINCREMENT, tournament_id INTEGER NOT NULL, user_id INTEGER, is_bot BOOLEAN DEFAULT 0, bot_name TEXT, joined_at DATETIME DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (tournament_id) REFERENCES tournaments(id) ON DELETE CASCADE, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE SET NULL );
            CREATE TABLE IF NOT EXISTS games ( id INTEGER PRIMARY KEY AUTOINCREMENT, tournament_id INTEGER, match TEXT, status TEXT DEFAULT 'pending', started_at DATETIME, finished_at DATETIME, external_game_id TEXT, FOREIGN KEY (tournament_id) REFERENCES tournaments(id) ON DELETE SET NULL);
            ...
            INSERT OR IGNORE INTO tournaments (id, name, created_by, status, players, bots, created_at) VALUES (1, 'Torneo Relámpago', 1, 'finished', 4, 0, datetime('now', '-1 days'));
            INSERT OR IGNORE INTO tournaments (id, name, created_by, status, players, bots, created_at) VALUES (2, 'Copa Velocidad', 3, 'finished', 4, 0, datetime('now', '-2 days'));
            INSERT OR IGNORE INTO tournaments (id, name, created_by, status, players, bots, created_at) VALUES (3, 'Torneo Express', 2, 'finished', 4, 0, datetime('now', '-3 days'));
            INSERT OR IGNORE INTO tournaments (id, name, created_by, status, players, bots, created_at) VALUES (4, 'Desafío Rápido', 5, 'finished', 4, 0, datetime('now', '-4 days'));
            INSERT OR IGNORE INTO tournaments (id, name, created_by, status, players, bots, created_at) VALUES (5, 'Torneo Flash', 7, 'finished', 4, 0, datetime('now', '-5 days'));
            ...
            INSERT OR IGNORE INTO tournaments (id, name, created_by, status, players, bots, bots_difficulty, created_at) VALUES (6, 'Torneo Total', 7, 'finished', 16, 1, "medium", datetime('now', '-1 days'));
            INSERT OR IGNORE INTO games (id, tournament_id, match, status, started_at, finished_at) VALUES (86, 6, '1/8(1)', 'finished', datetime('now', '-1 days', '15:00:00'), datetime('now', '-1 days', '15:00:00', '+7 minutes'));
            INSERT OR IGNORE INTO games (id, tournament_id, match, status, started_at, finished_at) VALUES (87, 6, '1/8(2)', 'finished', datetime('now', '-1 days', '15:08:00'), datetime('now', '-1 days', '15:08:00', '+6 minutes'));
            INSERT OR IGNORE INTO games (id, tournament_id, match, status, started_at, finished_at) VALUES (88, 6, '1/8(3)', 'finished', datetime('now', '-1 days', '15:04:00'), datetime('now', '-1 days', '15:04:00', '+4 minutes'));
            INSERT OR IGNORE INTO games (id, tournament_id, match, status, started_at, finished_at) VALUES (89, 6, '1/8(4)', 'finished', datetime('now', '-1 days', '15:02:00'), datetime('now', '-1 days', '15:02:00', '+7 minutes'));
            INSERT OR IGNORE INTO games (id, tournament_id, match, status, started_at, finished_at) VALUES (90, 6, '1/8(5)', 'finished', datetime('now', '-1 days', '15:01:00'), datetime('now', '-1 days', '15:01:00', '+8 minutes'));
            INSERT OR IGNORE INTO games (id, tournament_id, match, status, started_at, finished_at) VALUES (91, 6, '1/8(6)', 'finished', datetime('now', '-1 days', '15:02:00'), datetime('now', '-1 days', '15:02:00', '+7 minutes'));
            INSERT OR IGNORE INTO games (id, tournament_id, match, status, started_at, finished_at) VALUES (92, 6, '1/8(7)', 'finished', datetime('now', '-1 days', '15:01:00'), datetime('now', '-1 days', '15:01:00', '+8 minutes'));
            INSERT OR IGNORE INTO games (id, tournament_id, match, status, started_at, finished_at) VALUES (93, 6, '1/8(8)', 'finished', datetime('now', '-1 days', '15:00:00'), datetime('now', '-1 days', '15:00:00', '+7 minutes'));
            INSERT OR IGNORE INTO games (id, tournament_id, match, status, started_at, finished_at) VALUES (94, 6, '1/4(1)', 'finished', datetime('now', '-1 days', '15:10:00'), datetime('now', '-1 days', '15:10:00', '+9 minutes'));
            INSERT OR IGNORE INTO games (id, tournament_id, match, status, started_at, finished_at) VALUES (95, 6, '1/4(2)', 'finished', datetime('now', '-1 days', '15:09:00'), datetime('now', '-1 days', '15:09:00', '+7 minutes'));
            INSERT OR IGNORE INTO games (id, tournament_id, match, status, started_at, finished_at) VALUES (96, 6, '1/4(3)', 'finished', datetime('now', '-1 days', '15:10:00'), datetime('now', '-1 days', '15:10:00', '+3 minutes'));
            INSERT OR IGNORE INTO games (id, tournament_id, match, status, started_at, finished_at) VALUES (97, 6, '1/4(4)', 'finished', datetime('now', '-1 days', '15:11:00'), datetime('now', '-1 days', '15:11:00', '+4 minutes'));
            INSERT OR IGNORE INTO games (id, tournament_id, match, status, started_at, finished_at) VALUES (98, 6, '1/2(1)', 'finished', datetime('now', '-1 days', '15:18:00'), datetime('now', '-1 days', '15:18:00', '+7 minutes'));
            INSERT OR IGNORE INTO games (id, tournament_id, match, status, started_at, finished_at) VALUES (99, 6, '1/2(2)', 'finished', datetime('now', '-1 days', '15:18:00'), datetime('now', '-1 days', '15:18:00', '+6 minutes'));
            INSERT OR IGNORE INTO games (id, tournament_id, match, status, started_at, finished_at) VALUES (100, 6, 'Final', 'finished', datetime('now', '-1 days', '15:27:00'), datetime('now', '-1 days', '15:27:00', '+7 minutes'));
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (171, 86, 1, 0, 1, 'Team A');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (172, 86, NULL, 1, 0, 'Medium Bot 1');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (173, 87, 2, 0, 1, 'Team A');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (174, 87, NULL, 1, 0, 'Medium Bot 2');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (175, 88, 3, 0, 1, 'Team A');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (176, 88, NULL, 1, 0, 'Medium Bot 3');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (177, 89, 4, 0, 1, 'Team A');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (178, 89, NULL, 1, 0, 'Medium Bot 4');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (179, 90, 5, 0, 1, 'Team A');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (180, 90, NULL, 1, 0, 'Medium Bot 5');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (181, 91, 6, 0, 1, 'Team A');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (182, 91, 7, 1, 0, 'Team B');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (183, 92, NULL, 1, 1, 'Medium Bot 6');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (184, 92, NULL, 1, 0, 'Medium Bot 7');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (185, 93, NULL, 1, 0, 'Medium Bot 8');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (186, 93, NULL, 1, 1, 'Medium Bot 9');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (187, 94, 1, 0, 1, 'Team A');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (188, 94, 2, 0, 0, 'Team B');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (189, 95, 3, 0, 0, 'Team A');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (190, 95, 4, 0, 1, 'Team B');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (191, 96, 5, 0, 1, 'Team A');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (192, 96, 6, 0, 0, 'Team B');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (193, 97, NULL, 1, 1, 'Medium Bot 6');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (194, 97, NULL, 1, 0, 'Medium Bot 9');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (195, 98, 1, 0, 1, 'Team A');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (196, 98, 4, 0, 0, 'Team B');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (197, 99, 5, 0, 1, 'Team A');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (198, 99, NULL, 1, 0, 'Medium Bot 6');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (199, 100, 1, 0, 1, 'Team A');
            INSERT OR IGNORE INTO participants (id, game_id, user_id, is_bot, is_winner, team_name) VALUES (200, 100, 5, 0, 0, 'Team B');
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (171, 86, 1, 'Team A', 5);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (172, 86, NULL, 'Medium Bot 1', 3);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (173, 87, 2, 'Team A', 5);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (174, 87, NULL, 'Medium Bot 2', 0);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (175, 88, 3, 'Team A', 5);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (176, 88, NULL, 'Medium Bot 3', 1);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (177, 89, 4, 'Team A', 5);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (178, 89, NULL, 'Medium Bot 4', 3);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (179, 90, 5, 'Team A', 5);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (180, 90, NULL, 'Medium Bot 5', 4);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (181, 91, 6, 'Team A', 5);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (182, 91, 7, 'Team B', 3);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (183, 92, NULL, 'Medium Bot 6', 5);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (184, 92, NULL, 'Medium Bot 7', 3);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (185, 93, NULL, 'Medium Bot 8', 2);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (186, 93, NULL, 'Medium Bot 9', 5);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (187, 94, 1, 'Team A', 5);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (188, 94, 2, 'Team B', 3);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (189, 95, 3, 'Team A', 4);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (190, 95, 4, 'Team B', 5);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (191, 96, 5, 'Team A', 5);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (192, 96, 6, 'Team B', 1);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (193, 97, NULL, 'Medium Bot 6', 5);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (194, 97, NULL, 'Medium Bot 9', 3);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (195, 98, NULL, 'Team A', 5);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (196, 98, NULL, 'Team B', 4);
            INSERT OR IGNORE INTO scores (id, game_id, scorer_id, team_name, point_number) VALUES (197, 99, NULL, 'Team A', 5);
