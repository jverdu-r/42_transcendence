...
<<<<<<< HEAD
            INSERT OR IGNORE INTO user_profiles (user_id, avatar_url language, notifications, sound, difficulty) VALUES (1, NULL, '', 'es', 'true', 'true', 'easy');
            INSERT OR IGNORE INTO user_profiles (user_id, avatar_url language, notifications, sound, difficulty) VALUES (2, NULL, '', 'gl', 'false', 'true', 'normal');
            INSERT OR IGNORE INTO user_profiles (user_id, avatar_url language, notifications, sound, difficulty) VALUES (3, NULL, '', 'en', 'false', 'true', 'hard');
            INSERT OR IGNORE INTO user_profiles (user_id, avatar_url language, notifications, sound, difficulty) VALUES (4, NULL, '', 'es', 'true', 'false', 'easy');
            INSERT OR IGNORE INTO user_profiles (user_id, avatar_url language, notifications, sound, difficulty) VALUES (5, NULL, '', 'en', 'false', 'true', 'hard');
            INSERT OR IGNORE INTO user_profiles (user_id, avatar_url language, notifications, sound, difficulty) VALUES (6, NULL, '', 'es', 'true', 'false', 'hard');
            INSERT OR IGNORE INTO user_profiles (user_id, avatar_url language, notifications, sound, difficulty) VALUES (7, NULL, '', 'en', 'true', 'true', 'easy');
>>>>>>> origin/main
