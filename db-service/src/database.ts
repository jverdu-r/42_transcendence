...
export async function initializeDb() {
    ...
    try {
        await db.exec(`
            ...
            CREATE TABLE IF NOT EXISTS user_profiles ( user_id INTEGER PRIMARY KEY AUTOINCREMENT, avatar_url TEXT, language TEXT DEFAULT 'es', notifications TEXT DEFAULT 'true', doubleFactor BOOLEAN DEFAULT 'false', doubleFactorSecret TEXT DEFAULT NULL, difficulty TEXT DEFAULT 'normal', FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE);
            ...
            CREATE TABLE IF NOT EXISTS tournaments ( id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL, created_by INTEGER, status TEXT DEFAULT 'upcoming', max_players INTEGER, allow_early_start BOOLEAN default 'flase', created_at DATETIME DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (created_by) REFERENCES users(id) ON DELETE SET NULL);
            ...
            INSERT OR IGNORE INTO tournaments (id, name, created_by, status, max_players, allow_early_start, created_at) VALUES (1, 'Torneo Relámpago', 1, 'finished', 4, 'false', datetime('now', '-1 days'));
            INSERT OR IGNORE INTO tournaments (id, name, created_by, status, max_players, allow_early_start, created_at) VALUES (2, 'Copa Velocidad', 3, 'finished', 4, 'false', datetime('now', '-2 days'));
            INSERT OR IGNORE INTO tournaments (id, name, created_by, status, max_players, allow_early_start, created_at) VALUES (3, 'Torneo Express', 2, 'finished', 4, 'false', datetime('now', '-3 days'));
            INSERT OR IGNORE INTO tournaments (id, name, created_by, status, max_players, allow_early_start, created_at) VALUES (4, 'Desafío Rápido', 5, 'finished', 4, 'false', datetime('now', '-4 days'));
            INSERT OR IGNORE INTO tournaments (id, name, created_by, status, max_players, allow_early_start, created_at) VALUES (5, 'Torneo Flash', 7, 'finished', 4, 'false', datetime('now', '-5 days'));
