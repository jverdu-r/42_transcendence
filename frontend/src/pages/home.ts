...
export function renderHomePage(): void {
    // La lógica del idioma y el menú móvil del encabezado ahora se maneja en el componente `navbar.ts`.
    // Por lo tanto, eliminamos los listeners de eventos y la lógica relacionada con el idioma y el menú
    // del encabezado de esta página.
    ...
    const homeHtml = `
        <main class="flex-grow w-full p-4 sm:p-8 flex flex-col items-center gap-8 text-gray-100 animate__animated animate__fadeIn">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl w-full animate__animated animate__fadeInUp">
              ...
              >
                  <div>
                      <h2 class="text-4xl sm:text-5xl lg:text-6xl font-display font-extrabold mb-6 text-[#ffc300] drop-shadow-md leading-tight"> ${getTranslation('home', 'welcomeTitle')} <span class="text-[#ffd60a]">Transcendence</span>!
                      </h2>
                      <p class="text-base sm:text-lg md:text-xl text-gray-300 mb-8"> ${getTranslation('home', 'welcomeSubtitle')}
                      </p>
                  </div>
              ...
              >
                  <h3 class="text-2xl sm:text-3xl font-display font-extrabold text-[#ffc300] drop-shadow-md mb-6 text-center">${getTranslation('home', 'liveMatchesTitle')}</h3>
                  <p class="text-base sm:text-lg text-gray-300 mb-6 text-center">${getTranslation('home', 'liveMatchesSubtitle')}</p>
                  <div class="flex-grow space-y-4 overflow-y-auto max-h-96 pr-2 custom-scrollbar">
                      <a href="/match/1" class="block p-4 rounded-xl bg-[#001d3d] bg-opacity-50 text-gray-100 hover:bg-opacity-70 transition-all duration-200 shadow-md hover:shadow-lg cursor-pointer group border border-[#003566]">
                          <div class="flex justify-between items-center">
                              <span class="font-semibold text-base sm:text-lg">${getTranslation('home', 'playerA')} <span class="text-[#ffc300]">${getTranslation('home', 'vs')}</span> ${getTranslation('home', 'playerB')}</span>
                      ...
                      <a href="/match/2" class="block p-4 rounded-xl bg-[#001d3d] bg-opacity-50 text-gray-100 hover:bg-opacity-70 transition-all duration-200 shadow-md hover:shadow-lg cursor-pointer group border border-[#003566]">
                          <div class="flex justify-between items-center">
                              <span class="font-semibold text-base sm:text-lg">${getTranslation('home', 'teamX')} <span class="text-[#ffc300]">${getTranslation('home', 'vs')}</span> ${getTranslation('home', 'teamY')}</span>
                      ...
                      <a href="/match/3" class="block p-4 rounded-xl bg-[#001d3d] bg-opacity-50 text-gray-100 hover:bg-opacity-70 transition-all duration-200 shadow-md hover:shadow-lg cursor-pointer group border border-[#003566]">
                          <div class="flex justify-between items-center">
                              <span class="font-semibold text-base sm:text-lg">${getTranslation('home', 'playerCrack')} <span class="text-[#ffc300]">${getTranslation('home', 'vs')}</span> ${getTranslation('home', 'playerNovato')}</span>
                      ...
                      <a href="/match/4" class="block p-4 rounded-xl bg-[#001d3d] bg-opacity-50 text-gray-100 hover:bg-opacity-70 transition-all duration-200 shadow-md hover:shadow-lg cursor-pointer group border border-[#003566]">
                          <div class="flex justify-between items-center">
                              <span class="font-semibold text-base sm:text-lg">${getTranslation('home', 'champion')} <span class="text-[#ffc300]">${getTranslation('home', 'vs')}</span> ${getTranslation('home', 'challenger')}</span>
                      ...
                      <a href="/match/5" class="block p-4 rounded-xl bg-[#001d3d] bg-opacity-50 text-gray-100 hover:bg-opacity-70 transition-all duration-200 shadow-md hover:shadow-lg cursor-pointer group border border-[#003566]">
                          <div class="flex justify-between items-center">
                              <span class="font-semibold text-base sm:text-lg">${getTranslation('home', 'assassin')} <span class="text-[#ffc300]">${getTranslation('home', 'vs')}</span> ${getTranslation('home', 'master')}</span>
          ...
          <section class="w-full max-w-7xl mt-16 grid grid-cols-1 md:grid-cols-2 gap-8 mx-auto animate__animated animate__fadeInUp animate__delay-1s">
              <a href="/profile" class="block rounded-3xl p-4 sm:p-6 bg-white bg-opacity-5 backdrop-filter backdrop-blur-xl border border-[#003566] shadow-2xl hover:shadow-custom-deep hover:scale-[1.01] transition-all duration-500">
                  <h3 class="text-xl sm:text-2xl font-display font-bold text-[#ffc300] mb-3">${getTranslation('home', 'yourProfileTitle')}</h3>
                  <p class="text-sm sm:text-base text-gray-300">${getTranslation('home', 'yourProfileSubtitle')}</p>
              </a>
              <a href="/ranking" class="block rounded-3xl p-4 sm:p-6 bg-white bg-opacity-5 backdrop-filter backdrop-blur-xl border border-[#003566] shadow-2xl hover:shadow-custom-deep hover:scale-[1.01] transition-all duration-500">
                  <h3 class="text-xl sm:text-2xl font-display font-bold text-[#ffc300] mb-3">${getTranslation('home', 'globalRankingTitle')}</h3>
                  <p class="text-sm sm:text-base text-gray-300">${getTranslation('home', 'globalRankingSubtitle')}</p>
              </a>
          </section>
        </main>
        <style>
            /* Custom Scrollbar for Match History (replicated from profile.ts) */
            ...
            /* Custom Shadow for Hover Effect (deeper glow, replicated from profile.ts) */
